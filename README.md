...
```bash
pip install torch==1.10.0+cu113 torchvision==0.11.1+cu113 torchtext==0.11.0 torchaudio==0.10.0+cu113 -f https://download.pytorch.org/whl/cu113/torch_stable.html
